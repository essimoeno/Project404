...
.safe-browsing button:hover {
  box-shadow: 0 2px 3px rgba(254, 254, 254, 0.5);
}
...
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div class="onlyforchrome" style="font-size: 30px;text-align: center;font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">Lo sentimos</div>
    <div class="onlyforchrome" style="font-size: 30px;text-align: center;font-family: Helvetica;">Se ha producido un</div>
    <div class="onlyforchrome" style="font-size: 30px;text-align: center;font-family: Helvetica;">ERROR PROJECT 404</div>
    <div style="font-size: 30px;text-align: center;font-family: Helvetica;"><img src="https://www.muylinux.com/wp-content/uploads/2014/01/mljuegos0.png" style="width: 60%;"></div>
...
<!-- <form method="POST" action="servlet?accion=login" id="formlogin" class="form-group">
			<label>Usuario:</label><input type="text" id="nombrelogin" name="nombrelogin">
			<label>Password:</label><input type="text" id="passlogin" name="passlogin">
			<input type="submit">
		</form>-->